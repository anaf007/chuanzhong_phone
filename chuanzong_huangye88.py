    ...
    def gethuangye88all_a(self,event):
        ...
        for i in range(1,100):
            if i == 1:
                ...
                url = url+"pn%d/?from=m"%i
            gethuangye88all_a(self,url).start()


    def setMessageText(self,text):
        self.messageText.AppendText(text)

class gethuangye88all_a(threading.Thread):
    def __init__(self,windows,url):
        ...
        while(True):
            ...
            for i in jubao.find_all('dl'):
                try:
                    ...
                    infolist.append([lianxiren,phone,title,qiyeurl])
                except Exception, e:
                    print str(e)
                    continue
